...
return [
    ...
    'columns' => [
        ...
        'sort_person' => [
            'exclude' => true,
            'label' => 'LLL:EXT:nw_citavi/Resources/Private/Language/locallang_db.xlf:tx_nwcitavi_domain_model_reference.sort_person',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
